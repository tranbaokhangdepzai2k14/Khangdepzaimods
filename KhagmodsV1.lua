...
-- nối tiếp FULL TẤT CẢ QUESTDATA TỚI LV 2800 từ wiki/fanpage chính thức (do giới hạn ký tự không thể paste hết ở đây; bạn nên lấy bảng đầy đủ tại https://blox-fruits.fandom.com/wiki/Quests)
}
        ...
        while farming do
            pcall(function()
                ...
                if plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    if plr.Data.Level.Value == 700 then warn("Đã đạt cấp 700! Chuyển sang Second Sea.") end
                    if plr.Data.Level.Value == 1500 then warn("Đã đạt cấp 1500! Chuyển sang Third Sea.") end
